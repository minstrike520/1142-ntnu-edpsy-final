...
export const QUESTIONS: Question[] = [
  {
    ...
    options: [
      ...
      { text: '自我評估大腦狀態，分析自己對這個科目的先備知識有多少、需要花多少時間，並擬定備考策略。', score: { D: 3 } },
  ...
  },
  {
    ...
    options: [
      ...
      { text: '立刻進行任務監控，放慢閱讀速度或重新讀一遍，找出剛剛粗心漏掉的段落與盲點。', score: { D: 3 } },
      { text: '提醒自己如果不趕快讀完，今天晚上就不能去看想看的影集了。', score: { E: 3 } }
    ]
  },
  {
    id: 3,
    ...
    options: [
      ...
      { text: '自我審視對這題所運用到的解題策略是否合適，並根據當前情境脈絡去靈活選擇或切換策略。', score: { D: 3 } },
  ...
  },
  {
    ...
    options: [
      ...
      { text: '把混亂的文字與抽象的圖像整合出清晰心理表徵的「看懂感」。', score: { C: 3 } },
      { text: '能夠明確看清並掌握自己的認知歷程，深刻了解自己是如何理解這項複雜知識的。', score: { D: 3 } },
      { text: '理解這個概念能讓我在接下來的考試中獲得好分數、或是避免被當的悲慘後果。', score: { E: 3 } }
    ]
  },
  {
    id: 5,
    ...
    options: [
      ...
      { text: '老師上課會留給我們自學、自我監控進度以及遇到問題自我調整的空間。', score: { B: 3 } },
      { text: '簡報和板書設計得極具美感與圖文，能引導我的聽覺與視覺同時主動處理訊息。', score: { C: 3 } },
      { text: '老師會引導我們反思學習結果，並給予時間讓我們自我審視當前的理解程度與吸收成效。', score: { D: 3 } },
  ...
  },
  {
    ...
    options: [
      ...
      { text: '充分掌握自己的學習強項與弱點，並進行有效的計畫與評估。', score: { D: 3 } },
      { text: '設計一套獎懲分明的操作系統，透過增強物來強烈塑造出固定的讀書慣性。', score: { E: 3 } }
    ]
  }
];
